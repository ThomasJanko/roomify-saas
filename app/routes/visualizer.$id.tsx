...
const VisualizerId = () => {
   ...
   const handleExport = async () => {
      ...
      const filename = `Roomify-${project?.name || id || 'render'}.png`.replace(/\s+/g, '-');
      try {
   ...
   const runGeneration = async (item: DesignItem) => {
      ...
      try {
         ...
         if (result.renderImage) {
            ...
            //update prject and DB
            const updatedItem = {
               ...item,
               renderedImage: result.renderImage,
               renderedPath: result.renderPath,
               timestamp: Date.now(),
               ...
               <div className="compare-stage">
                  {project?.sourceImage && currentImage ? (
                     ...
                     <div className="compare-fallback">
                        {project?.sourceImage && (
                           <img src={project.sourceImage} alt="Original" className="compare-img" />
                        )}
                     </div>
                  )}
               </div>
